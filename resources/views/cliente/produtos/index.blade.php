                    ...
                    <div class="card flex-fill" style="width: 18rem;">
                        ...
                        <div class="card-body d-flex justify-content-around">
                            ...
                            <form action="{{ route('cliente.carrinho.adicionar') }}" method="post">
                                ...
                                <button type="submit" name="action" value="carrinho" class="btn btn-secondary"><i class="fas fa-plus"></i> Carrinho</button>
                                <button type="submit" name="action" value="comprar" class="btn btn-primary"><i class="fas fa-plus"></i> Comprar</button>
                            </form>
                        </div>
                    </div>
                </div>
