            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group d-flex align-items-end">
                        <div class="">
                            <img id="categoria-icon" src="{{$produto->categoria->getIconeUrlAttribute()}}" alt="Ícone da Categoria"
                                style=" margin-left: 10px; width: 50; height: 50px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-4 form-group">
                        ...
                        <input disabled type="number" class="form-control @error('quantidade') is-invalid @enderror" id="quantidade"
